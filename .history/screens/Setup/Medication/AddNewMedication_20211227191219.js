        ...
        <View>
            ...
            <View>
                ...
                <View style={styles.autocompletesContainer}>
                    <Autocomplete containerStyle={width='20%'} style={styles.inputContainer} handleSelectItem={(item, id) => this.handleSelectItem(item, id)} data={data} valueExtractor={item => item} />
                </View>
