        ...
        <View>
            ...
            <View>
                ...
                <View style={styles.autocompletesContainer}>
                    <Autocomplete containerStyle={width='20%'} style={styles.input, { borderWidth:'100%'}} handleSelectItem={(item, id) => this.handleSelectItem(item, id)} data={data} valueExtractor={item => item} />
                </View>
