...
const AddNewMedication = props => {
    ...
    console.log("ArrayOBJ:" + arrayObj.DOSEAGE);
    console.log("ArrayOBJ:" + arrayObj[0].DOSEAGE);
    ...
    useEffect(() => {
        ...
        fetch(api).then((response) => response.json())
            .then((data) => setMedNAMEData(JSON.stringify(data)))
            .catch((error) => alert(error))
    }, []);

    //console.log(JSON.stringify(data.DISPLAY_NAME.DOSEAGE[1]))
