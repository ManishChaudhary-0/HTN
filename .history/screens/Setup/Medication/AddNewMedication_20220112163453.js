...
import {Autocomplete2} from "react-native-dropdown-autocomplete";
...
// MedDoseages.filter(x => x !== undefined)
    ...
    //console.log(MedDoseages)
    console.log(fetch(`https://clinicaltables.nlm.nih.gov/api/rxterms/v3/search?maxList=15&terms=${Medication}&ef=DISPLAY_NAME,STRENGTHS_AND_FORMS`))
