...
import gg from 'autocomplete-lhc';
    ...
    return(
        ...
        <View>
            ...
            <View>
                ...
                {/* <link href='https://clinicaltables.nlm.nih.gov/autocomplete-lhc-versions/17.0.2/autocomplete-lhc.min.css' rel="stylesheet"></link>
                ...
                <TextInput style={styles.inputLabel} type="text" id="rxterms" placeholder="Drug name"/>
                <TextInput style={styles.inputLabel} type="text" id="drug_strengths" placeholder="Strength list"/>
