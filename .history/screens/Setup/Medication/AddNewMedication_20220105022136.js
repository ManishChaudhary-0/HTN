...
//    // console.log(":-----------------------------------------------------------------------------------------:");
    ...
    const getmedAPIData = async(text) => {
        ...
        try {
            const response = await fetch(`https://clinicaltables.nlm.nih.gov/api/rxterms/v3/search?maxList=1000&terms=${text}&ef=DISPLAY_NAME,STRENGTHS_AND_FORMS`).then((response) => response.json())
                ...
                <View>
                    ...
                    <View style={styles.container}>
                        ...
                        // containerStyle={styles.autocompleteContainer2}
                            ...
                            //     keyboardShouldPersistTaps: 'always',
                            //     renderItem: ({item})  => (
                            //     <TouchableOpacity onPress={() => setMedication(item)}>
