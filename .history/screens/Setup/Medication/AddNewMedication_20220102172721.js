...
const AddNewMedication = props => {
    ...
    const getMedData = async() => {
        try {
            ...
            setmedData(JSON.parse(JSON.stringify(json)));
            setLoading(true);
           // console.log(medData);
           // console.log(JSON.parse(JSON.stringify(json.DISPLAY_NAME[0])));
            ...
            console.log(medData[2].DISPLAY_NAME[0]);
            console.log(medData[2].STRENGTHS_AND_FORMS[0]);
            console.log(medData[2].DISPLAY_NAME[1]);
            console.log(medData[2].STRENGTHS_AND_FORMS[1]);
