...
import newAPI from '/Users/manishchaudhary/Hypertension_Analysis_Application/apis/medApi.js';
...
const AddNewMedication = props => {
    ...
    function getMedData() {
        ...
        .then(function(response){
            ...
            console.log(MedNAMEData[1].toString())
    ...
    useEffect(() => {
        ...
        console.log(newAPI.get(`?terms=${apiMed}&ef=DISPLAY_NAME,STRENGTHS_AND_FORMS`))
    }, []);
