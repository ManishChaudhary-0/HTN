...
//                         <NumberPlease
//                             digits={dose}
//                             itemStyle={{height:88, color: "#000000", marginLeft:3}} 
//                             // pickerStyle={{width:390, marginTop:-60}}
//                             pickerStyle={{width:390}}
//                             values={Dose}
//                             onValueChange={(values) => setDose(values)}
//                         />
//                     </View>
...
//                     <Text style={{textAlign: 'left', fontSize: 21, marginTop:-60, paddingLeft:20, color:"#393939" }}>  Select Quantity: </Text>

//                     <Picker style={{width: '98%', marginTop:-30, marginLeft:3}} itemStyle={{height:110, color: "#000000"}} selectedValue={Quantity} onValueChange={currentRace => setQuantity(currentRace)}>
//                         <Picker.Item label="Select Quantity" value="Home" />
//                         <Picker.Item label="1" value="1" />
//                         <Picker.Item label="2" value="2" />
//                         <Picker.Item label="3" value="3" />
...
//                         values={Freq}
//                         pickerStyle={{width:390}}
//                         onChange={(values) => setFreq(values)}
//                     />
//                 </View>
