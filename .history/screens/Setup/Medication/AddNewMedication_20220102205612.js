...
const AddNewMedication = props => {
   ...
   // console.log(":-----------------------------------------------------------------------------------------:");
    ...
    const [pickerVal, setPickerVal] = useState('Doseage');
    ...
    const getmedAPIData = async() => {
        try {
           ...
           // console.log(apiMedsFound);
            ...
            for(let i = 0; i < apiMedsFound; i++){
              ...
              //  console.log(medAPIData[2].DISPLAY_NAME[i]);
              //  console.log(medAPIData[2].STRENGTHS_AND_FORMS[i]);
            }
         ...
         //   console.log(DOSES);
            ...
            // console.log(medAPIData[0]);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
            // console.log(medAPIData[2].DISPLAY_NAME[0]);
            // console.log(medAPIData[2].STRENGTHS_AND_FORMS[0]);
            // console.log(medAPIData[2].DISPLAY_NAME[1]);
            // console.log(medAPIData[2].STRENGTHS_AND_FORMS[1]);
        }
        catch (error) {
            console.error(error);
        }
        ...
        //medAPIData has the JSON ARRAY  NOW WE NEED TO PARSE AND STORE IT
    ...
    return(
        ...
        <View>
            ...
            <View>
                ...
                <View style={{paddingTop:0, paddingBottom:60}}>
                    <Picker selectedValue={pickerVal} style={{height:50, width:150}} onValueChange={(itemValue, itemIndex) => setPickerVal(itemValue)}>
                        <Picker.item label={MedDoseages} value="JAVA"/>
                        <Picker.item label="HELLO" value="HEL"/>
                    </Picker>
                </View>
