    ...
    return(
        <View>
            ...
            <View style={styles.VGrid}>
                ...
                <TextInput style={styles.inputLabel} placeholder={lastName} placeholderTextColor='#696969'/>
                <TextInput style={styles.inputLabel} placeholder={email} placeholderTextColor='#696969' keyboardType='email-address' />
                <TextInput style={styles.inputLabel} placeholder={password} placeholderTextColor='#696969'/>
                <TextInput style={styles.inputLabel} placeholder={confirmPassword} placeholderTextColor='#696969'/>
