...
const GeneralInformation = props => {
    ...
    useEffect(() => {
        console.warn("Testing", passwordMatchingHandler)
    });
    ...
    return(
        <View>
            ...
            <View style={styles.VGrid}>
                ...
                <TextInput style={styles.inputLabel} placeholder={password} placeholderTextColor='#696969' onChangeText={text => setPassword(text)}/>
                {/* {!isPasswordValid && <Text color='#000000'>Password Incorrect!</Text>} */}
            ...
            <View style={{alignItems: 'flex-start', marginTop: '110%'}}>
