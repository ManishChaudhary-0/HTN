        ...
        <View >
            <SafeAreaView style={{marginTop: 70, marginRight: 0, marginLeft: 0}}>
                <Appbar.Header style={styles.appBar}>
                    ...
                    <Appbar.Content title="Delete Medication" titleStyle={{fontSize: 24}}/>
                </Appbar.Header>
            </SafeAreaView>
                        
                    
            <Text style={{textAlign: 'center', fontSize: 21, paddingTop:45, padding:10, color:"#393939" }}>  Select which medication you would like to delete. </Text>
            ...
            <View style={{alignItems: 'center'}}>
                <Pressable style={styles.press3} onPress={() => {props.navigation.navigate({routeName: 'MedicationReview2'});}}>
                    <Text style={styles.buttonText}>
                        Return To Review
                    </Text>
                </Pressable>
