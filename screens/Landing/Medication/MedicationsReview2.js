    ...
    return (
        <View >
            ...
            <View style={{alignItems: 'center'}}>
                <Pressable style={styles.pressAdd} onPress={() => {props.navigation.navigate({routeName: 'AddNewMedication2'});}}>
            ...
            <View style={{alignItems: 'center'}}>
                <Pressable style={styles.press} onPress={() => {props.navigation.navigate({routeName: 'DeleteMedication'});}}>
                    <Text style={styles.buttonText}>
                        Delete Medication
                    </Text>
                </Pressable>
...
export default MedicationReview2;