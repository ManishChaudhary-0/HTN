        ...
        <View >
            ...
            <View>
                ...
                <View style={{marginVertical:10}}>
                    ...
                    <Text style={{textAlign: 'left', fontSize: 21, paddingTop:30, paddingLeft:20, color:"#393939" }}>  Select Frequency: </Text>
                    ...
                    <NumberPlease
                        digits={dose}
                        itemStyle={{height:110, color: "#000000", marginLeft:3}} 
                        values={height}
                ...
                <Pressable style={styles.press}  onPress={() => {props.navigation.navigate({routeName: 'MedicationReview2'});}} >
...
export default AddNewMedication2;
