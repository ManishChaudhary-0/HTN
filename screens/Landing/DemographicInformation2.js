...
const DemographicInformation2 = props => {
        ...
        <View >
            <SafeAreaView style={{marginTop: 70, marginRight: 0, marginLeft: 0}}>
                <Appbar.Header style={styles.appBar}>
                    ...
                    <Appbar.Content title="Demographic Information" titleStyle={{fontSize: 23.2}}/>
                </Appbar.Header>
            </SafeAreaView>
        
            <View style={{padding:10}}>
             <Text style={{textAlign: 'center', fontSize: 18, paddingTop:0, color:"#393939", marginTop:70}}>  Click to enter Date of Birth: </Text>
...
export default DemographicInformation2;