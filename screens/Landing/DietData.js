        ...
        <View >
            <SafeAreaView style={{marginTop: 70, marginRight: 0, marginLeft: 0}}>
                <Appbar.Header style={styles.appBar}>
                    ...
                    <Appbar.Content title="Diet Data" titleStyle={{fontSize: 24}}/>
                </Appbar.Header>
            </SafeAreaView>
        
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Grains - Average</Text>
            ...
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Proteins - Average</Text>
                    <Card style={{width:300, height:40, backfaceVisibility:'hidden', backgroundColor:'#73000a', marginLeft:40}}>
                        <Card.Content alignItems='center'>
                        </Card.Content>
                    </Card>
            ...
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Vegetables - Average</Text>
                    <Card style={{width:300, height:40, backfaceVisibility:'hidden', backgroundColor:'#73000a', marginLeft:40}}>
                        <Card.Content alignItems='center'>
                        </Card.Content>
                    </Card>
            ...
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Fruits - Average</Text>
                    <Card style={{width:300, height:40, backfaceVisibility:'hidden', backgroundColor:'#73000a', marginLeft:40}}>
                        <Card.Content alignItems='center'>
                        </Card.Content>
                    </Card>
            ...
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Dairy - Average</Text>
                    <Card style={{width:300, height:40, backfaceVisibility:'hidden', backgroundColor:'#73000a', marginLeft:40}}>
                        <Card.Content alignItems='center'>
                        </Card.Content>
                    </Card>
            ...
            <View style={{flexDirection: 'column', paddingTop: 40}}>
                <View>
                    <Text style={styles.infoText}> Fats/Oils - Average</Text>
                    <Card style={{width:300, height:40, backfaceVisibility:'hidden', backgroundColor:'#73000a', marginLeft:40}}>
                        <Card.Content alignItems='center'>
                        </Card.Content>
                    </Card>
