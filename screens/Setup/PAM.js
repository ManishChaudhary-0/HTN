        ...
        <View style={{flex:1}} >
            <SafeAreaView style={{marginTop: 70, marginRight: 0, marginLeft: 0}}>
                <Appbar.Header style={styles.appBar}>
                    <Appbar.Content title="Motivation Measurement" titleStyle={{fontSize: 24}}/>
                </Appbar.Header>
            </SafeAreaView>
            ...
            {/* </ScrollView> */}
                <View style={{}}>
                    <View style={{alignItems: 'center'}}>
                        <Pressable style={styles.press} onPress={() => {props.navigation.navigate({routeName: 'SProfileReview'});}}  >
